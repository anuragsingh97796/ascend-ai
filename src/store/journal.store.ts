...
interface JournalActions {
  addEntry: (
    entry: Omit<JournalEntry, "id" | "wordCount" | "createdAt" | "updatedAt">
  ) => void;
  updateEntry: (
    id: string,
